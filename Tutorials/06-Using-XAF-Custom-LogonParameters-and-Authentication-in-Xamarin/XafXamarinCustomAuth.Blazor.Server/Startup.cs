...
using XafXamarinCustomAuth.Blazor.Server.Services;
...
namespace XafXamarinCustomAuth.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<XafXamarinCustomAuthBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(XafXamarinCustomAuth.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // Comment out the following line if using PermissionPolicyUser or a custom user type.
                options.UserLoginInfoType = typeof(XafXamarinCustomAuth.Module.BusinessObjects.ApplicationUserLoginInfo);
