...
namespace XafXamarinCustomAuth.Blazor.Server {
    public partial class XafXamarinCustomAuthBlazorApplication : BlazorApplication {
        public XafXamarinCustomAuthBlazorApplication() {
            InitializeComponent();
       ...
       ((CustomLogonParameters)e.LogonParameters).RefreshPersistentObjects(e.ObjectSpace);
        ...
        private void XafXamarinCustomAuthBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
