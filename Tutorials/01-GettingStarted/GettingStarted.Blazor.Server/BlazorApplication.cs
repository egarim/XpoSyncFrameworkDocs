...
namespace GettingStarted.Blazor.Server {
    public partial class GettingStartedBlazorApplication : BlazorApplication {
        public GettingStartedBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void GettingStartedBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
