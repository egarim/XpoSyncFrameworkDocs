...
namespace XafXamarinCustomAuth.Mobile.Infrastructure
{


    public abstract class ViewModelBase : BindableBase, IInitialize, INavigationAware, IConfirmNavigation, IDestructible
    {
        ...
        protected virtual async void NavigateAbsoluteCommandExecute(string uri)
        {
            ...
            await this.NavigationService.NavigateAsync(uri, null, false, true);
        }
        ...
        protected virtual async void NavigateModalCommandExecute(string uri)
        {
            ...
            await this.NavigationService.NavigateAsync(uri, null, useModalNavigation: true, true);
        }
        ...
        protected virtual async void NavigateNonModalCommandExecute(string uri)
        {
            ...
            await this.NavigationService.NavigateAsync(uri, null, useModalNavigation: false, true);
        }
