...
namespace UsingExistingDb.Blazor.Server {
    public partial class UsingExistingDbBlazorApplication : BlazorApplication {
        public UsingExistingDbBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void UsingExistingDbBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
