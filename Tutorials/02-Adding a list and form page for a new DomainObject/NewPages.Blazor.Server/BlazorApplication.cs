...
namespace NewPages.Blazor.Server {
    public partial class NewPagesBlazorApplication : BlazorApplication {
        public NewPagesBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void NewPagesBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
